...
function calc(){
 ...
 function calcTotal() {
  ...
  if (sex === 'female') {
   result.textContent = Math.round(((9.247 * weight) + (3.098 * height) - (4.330 * age) + 447.593) * ratio)
  } else {
   result.textContent = Math.round(((13.397 * weight) + (4.799 * height) - (5.677 * age) + 88.362) * ratio)
  }
...
forms.forEach(item => {
 ...
 function bindPostData(form) {
  form.addEventListener('submit', (e) => {
   ...
   (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', JSON.stringify(object)).then(data => {
    console.log(data);
